      ...
      <div class="max-w-4xl mt-10 mx-auto text-center">
        ...
        <div class="p-4 sm:p-8 lg:p-12 bg-gray-100 rounded-lg shadow-md sm:ml-0 md:ml-[-1rem] md:mr-[-1rem] lg:ml-[-6rem] lg:mr-[-5rem] xl:ml-[-13rem] xl:mr-[-13rem]">
          <p class="mb-4 sm:text-base">
            ...
            Mosquitoes are nocturnal creatures and tend to hide during the day.
            If you notice live Mosquitoes scurrying around at night or find
            small dark droppings resembling coffee grounds, it could indicate an
            infestation.
          </p>
          <p class="mb-4 sm:text-base">
            <span class="font-semibold">Unpleasant odor:</span>
            Mosquitoes emit a distinctive musty odor that can become noticeable
          ...
          <p class="mb-4 sm:text-base">
            Dealing with a Mosquito infestation requires professional expertise.
            A licensed pest control company can assess the severity of the
            infestation and implement appropriate Mosquito control measures.
            This may include insecticide treatments, baits, and sealing entry
            points to prevent further infestations.
          </p>
        </div>
        ...
        <div class="mt-10 flex flex-col items-start text-start container font-bold">
          <ul class="list-disc pl-6 space-y-2">
            <li>
              Mosquitoes are active mostly during nighttime or in dark,
              concealed areas.
            </li>
            <li>
            ...
            <li>
              Mosquitoes can travel and infest new areas by navigating through
              gaps and openings, and they are also known to be carried in
              infested items such as bags, boxes, and furniture.
            </li>
            <li>
              Remember, if you suspect a Mosquito infestation in your property,
            ...
            <li class="text-red-500">
              Remember, if you suspect a mosquito infestation on your property,
